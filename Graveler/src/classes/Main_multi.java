 ...
 * some of the calculated paralyzes would have happened after gravelers death in
 * game.
 * 
 ...
 * down time. This works well as dividing the same code into 100 Tasks speeds
 * the whole code up from ~255 seconds to around 24.24 seconds
 * 
 * edit: i changed some types from integer to long to allow for more runs if
 * needed this didn't change how long it took for 1000000000
 */
public class Main_multi
{
	...
	{
		// Change run and task_number as needed but make sure run is dividable by
		// task_number
		...
		System.out.println("The Execution of " + run + " Runs took " + full_seconds + "."
				+ (finish - start - full_seconds) + " Seconds.");
